...
```powershell
Expand-Archive -Path ".\MM-Projects-Gallery-UX-Fix-Patch.zip" -DestinationPath "." -Force
powershell -ExecutionPolicy Bypass -File ".\MM-Projects-Gallery-UX-Fix-Patch\apply-patch.ps1"
npm run dev
```
