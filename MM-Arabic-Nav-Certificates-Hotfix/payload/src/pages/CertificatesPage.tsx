    ...
    <div className="pt-28 pb-24">
      ...
      >
        ...
        <div className="content-container relative z-10 text-center">
          ...
          >
            {isArabic
              ? 'معلومات المستندات الرسمية المقدمة ضمن ملف شركة إم إم للمقاولات والتوريدات، وتشمل التسجيلات الضريبية والسجل التجاري وعضوية اتحاد المقاولين والاتفاقيات القانونية.'
              : 'Information from the official documents supplied in the MM Contracting & Supplying Co. profile, including tax registrations, commercial registration, contractor federation membership and legal agreements.'}
          </motion.p>
        </div>
      </div>
