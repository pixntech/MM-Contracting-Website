  ...
  return (
    ...
    >
      <img
        ...
        style={{ maxWidth: '30%', maxHeight: '30%', aspectRatio: 'auto' }}
      />
    </div>
  )
}
      ...
      <Suspense fallback={<PageLoading />}>
        ...
        <Routes>
          <Route element={<Layout />}>
            ...
            <Route path="/gallery/:projectId" element={<ProjectDetailsPage />} />
            {/* Keep the old URL working, but use the same gallery experience. */}
