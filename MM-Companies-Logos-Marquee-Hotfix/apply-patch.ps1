...
$files = @(
    ...
    "src/types/index.ts",
    "public/clients/ezz-steel.png",
    "public/clients/ceramica-cleopatra.png"
)
...
Write-Host ""
Write-Host "MM Companies Logos + Marquee Hotfix" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Companies logos + marquee hotfix applied successfully." -ForegroundColor Cyan
