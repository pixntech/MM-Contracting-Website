      ...
      <div className="content-container">
        <div className="flex items-center justify-between h-20 md:h-24">
          ...
          <div className="flex items-center gap-2">
            ...
            <nav className="hidden xl:flex items-center gap-0.5" role="navigation" aria-label={t('header.navAria')}>
              {visibleNav.map((link) => (
                <Link
                  key={link.href}
                  to={link.href}
            ...
            <Link
              ...
              className={cn(
                'hidden xl:inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold rounded-xl transition-all duration-300',
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="xl:hidden bg-white border-t border-border"
          >
