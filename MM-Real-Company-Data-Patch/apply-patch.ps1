...
function Resolve-ProjectRoot {
    ...
    throw "Could not detect the MM project root. Run this from the project root or pass -ProjectRoot <path>."
}
...
Write-Host ""
Write-Host "MM Real Company Data Patch" -ForegroundColor Cyan
Write-Host "Project: $root"
Write-Host "Backup:  $backupRoot"
Write-Host ""

foreach ($rel in ($updateFiles + $deleteFiles)) {
...
Write-Host "No npm install is required for this patch." -ForegroundColor Cyan
Write-Host ""
